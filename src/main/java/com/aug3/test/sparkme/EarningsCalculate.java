...
public class EarningsCalculate {
	...
	private static final String MYSQL_PWD = "user";
	private static final String MYSQL_CONNECTION_URL = "jdbc:mysql://192.168.0.3:3306/ada-fd?user=" + MYSQL_USERNAME
			+ "&password=" + MYSQL_PWD;
	...
	public static void main(String[] args) {
		...
		options.put("dbtable", "(select dt,tick,close from hq_price where dt = '2015-10-23') as quotes");
